      ...
      <Container className="w-75 mb-5" style={{ marginTop: "150px" }}>
        <Form onSubmit={(e) => handleSubmit.mutate(e)}>
          ...
          <Form.Group className="mb-3 " controlId="area">
            ...
            <Form.Select style={{ backgroundColor: "white"}} onChange={handleChange} className="bgad" name="area" aria-label="Default select example">
              <option></option>
          ...
          <Form.Group className="mb-3 " controlId="description">
            ...
            <Form.Control  onChange={handleChange} className="rs bgad" as="textarea" name="description" style={{ height: "80px",backgroundColor: "white" }} />
          </Form.Group>
          <div className="d-flex justify-content-center mt-5">
            <Button style={{ padding: "8px 100px" }} variant="success" type="submit">
              Save
            </Button>
          </div>
        </Form>
