...
import CodeQr from "../assets/img/note.png";
...
export default function MyBooking(props) {
  ...
  useEffect(() => {
    ...
    const myMidtransClientKey = "SB-Mid-client-FxsLKLP5Afh6XKel";
  ...
  return (
    <>
      ...
      <Container className="myc fmb" style={{ width: "60%", marginTop: "200px" }}>
        <div className="border border-3 p-4 pe-0 pb-0 bg-white">
        ...
        <div className="d-flex justify-content-end">
          <Button variant="success" type="submit" style={{ width: "200px" }} onClick={() => handleTransaction.mutate()}>
            Pay
          </Button>
        </div>
      </Container>
