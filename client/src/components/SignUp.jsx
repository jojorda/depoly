...
export default function SignUp(props) {
  ...
  return (
    <Modal {...props} aria-labelledby="contained-modal-title-vcenter" centered>
      ...
      >
        <h1 className="fw-bold text-center my-3">Sign Up</h1>
        <Form
        ...
        >
          <Form.Group className="mb-3" controlId="fullName">
            ...
            <Form.Control type="text" placeholder="Full Name" name="fullName" value={userSignUp.fullName} onChange={handleOnChange} />
          </Form.Group>
          <Form.Group className="mb-3" controlId="userName">
            <Form.Label className="fw-bold">Username</Form.Label>
            <Form.Control type="text" placeholder="Username" name="userName" value={userSignUp.userName} onChange={handleOnChange} />
          </Form.Group>
          <Form.Group className="mb-3" controlId="email">
            <Form.Label className="fw-bold">Email</Form.Label>
            <Form.Control type="email" placeholder="Email" name="email" value={userSignUp.email} onChange={handleOnChange} />
          </Form.Group>
          <Form.Group className="mb-3" controlId="phone">
            <Form.Label className="fw-bold">phone</Form.Label>
            <Form.Control type="text" placeholder="Phone Number" name="phone" value={userSignUp.phone} onChange={handleOnChange} />
          </Form.Group>
          ...
          <Button onClick={(e) => redirectSignin(e)} className="w-100" variant="success" type="submit">
            Sign Up
          </Button>
        </Form>
      </Modal.Body>
